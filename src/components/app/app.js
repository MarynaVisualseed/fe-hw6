...
class App extends Component {
  ...
  render() {
    ...
    const productsNumeric = parseInt(products);
    const increasedNumeric = parseInt(increased);

    return (
      <div className="app">
        <AppInfo products={productsNumeric} increased={increasedNumeric} />
        <PieChartComponent
          className="pie-block"
          products={productsNumeric}
          increased={increasedNumeric}
        />
